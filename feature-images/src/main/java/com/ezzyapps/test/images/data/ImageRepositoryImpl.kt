package com.ezzyapps.test.images.data
...
import com.ezzyapps.test.images.data.mappers.toFullImage
import com.ezzyapps.test.images.data.mappers.toLocal
import com.ezzyapps.test.images.data.mappers.toPreview
...
class ImageRepositoryImpl @Inject constructor(
    ...
    private fun fetchRemoteHits(
        ...
        val response = client.getImageHits(query, page, perPage, type).execute()
